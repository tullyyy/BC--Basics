...
function cleanAssets(done) {
  return del(["dist/**/*.html", "dist/fonts/**/*", "dist/img/**/*"], {
    force: true
  });
}
...
// structure: creates strcuture
// publish: copies from src to dist
// build: does all building SVGTextPositioningElement, all src code to dist in production way (minification)
// build_dev: faster but only for compileScssDevelopment
// watch: builds for develop but watches the files so whenever you change them it immediately pushes changes